...
export default function KelolaAkun() {
  ...
  return (
    <MainLayout>
      <PageHeader breadcrumb="Sipinjam / Kelola Akun" title="Kelola Akun Pengguna" />
            ...
            <div className="md:hidden flex flex-col gap-4">
              {items.map((item) => (
                <div key={item.user_id} className="border border-gray-100 rounded-2xl p-5">
                  ...
                  <p className="text-xs text-[#8789C0] mb-4">{item.email}</p>

                  <div className="space-y-2.5 mb-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-[#5B69B9]">NOK</span>
                      <span className="text-sm font-semibold text-[#2B3674]">{item.nok}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-[#5B69B9]">Jabatan</span>
                      <span className="text-sm font-semibold text-[#2B3674]">{item.jabatan || '-'}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-[#5B69B9]">Terdaftar</span>
