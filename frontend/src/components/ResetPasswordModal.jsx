          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full placeholder-[#8789C0] text-[#2B3674] px-3.5 py-2.5 pr-10 border border-gray-300 rounded-lg text-sm outline-none focus:border-[#003399]"
                required
              />
              <button
                type="button"
                onClick={() => setShowPassword((v) => !v)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8789C0] hover:text-[#2B3674]"
                tabIndex={-1}
              >
